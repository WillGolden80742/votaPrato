...
class QualificacaosControllerTest < ActionDispatch::IntegrationTest
  setup do
    @qualificacao = qualificacaos(:one)
  end

  test "should get index" do
    get qualificacaos_url
  ...
  test "should create qualificacao" do
    assert_difference("Qualificacao.count") do
      post qualificacaos_url, params: { qualificacao: { cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id, valor_gasto: @qualificacao.valor_gasto } }
    end
  ...
  test "should destroy qualificacao" do
    ...
    assert_redirected_to qualificacaos_url
  end
end
